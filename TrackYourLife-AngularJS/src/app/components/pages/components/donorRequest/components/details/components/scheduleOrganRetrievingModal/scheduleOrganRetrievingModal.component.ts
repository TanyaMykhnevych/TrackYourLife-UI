...
import {IScheduleMedicalExamViewModel, IScheduleOrganRetrievingViewModel} from "../../../../donorRequest.models";
...
export class ScheduleOrganRetrievingModalComponent extends BaseModalComponent<IScheduleOrganRetrievingViewModel> {
  ...
  public save(): Promise<any> {
    return this.donorRequestResource.scheduleOrganRetrievingTime(this.entity).then(() => {
      this.successClose();
    });
  }
